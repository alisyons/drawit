...
// i have to wait until preload() and setup() is done because p5 seems to
// dislike allocating anything into main.js and stops working :(
postSetup();

window.addEventListener("DOMContentLoaded", (event) => {
  document.getElementById('word-gen').addEventListener('click', () => {
    generatePrompt();
  })
});
